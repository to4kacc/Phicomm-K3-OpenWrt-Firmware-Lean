...
sed -i '/<tr><td width="33%"><%:CPU usage (%)%>/a\ /\t\t<tr><td width="33%"><%:CPU Temperature%></td><td><%=luci.sys.exec("cut -c1-2 /sys/class/thermal/thermal_zone0/temp")%>℃' feeds/luci/modules/luci-mod-admin-full/luasrc/view/admin_status/index.htm
